...
public class Home_Activity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    String[] listnama;
    public static ArrayList<com.example.exeercise1fix.ClassNama> classNamaArrayList = new ArrayList<com.example.exeercise1fix.ClassNama>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < listnama.length; i++) {
            com.example.exeercise1fix.ClassNama classNama = new com.example.exeercise1fix.ClassNama(listnama[i]);
